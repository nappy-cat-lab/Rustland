...
public class TextManager : MonoBehaviour
{
	...
	public void DisplayAudioMessage (string message, Color textColor, float delay, float audioDelay)
	{
		float startTime = Time.time + delay + 0.5f;
		float displayDuration = message.Length * displayTimePerCharacter + audioDelay;
		float newClearTime = startTime + displayDuration;
